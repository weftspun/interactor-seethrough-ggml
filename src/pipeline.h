...
struct PipelineConfig {
	...
	// --bf16: load f16 weights as bf16 and stop forcing GGML_PREC_F32 in
	// matmul. Targets the ~2x GEMM throughput that f32 accumulation costs.
	// Off by default: bf16 drops 3 mantissa bits vs f16 and must clear the
	// Lean witness gate before it can be a default.
	bool bf16 = false;
