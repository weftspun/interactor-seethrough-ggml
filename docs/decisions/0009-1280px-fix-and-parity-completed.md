# 1280px collapse fix, upstream parity, and Q4_0 validation: completed work
...
MADR 0008 tracked five open checklist items. Four landed on `main` this
session (the fifth, layer-quality polish, stays open in MADR 0008 —
blocked on a repro case). This record captures the four completed items
in full, per the split convention established by MADR 0004.
...
Everything still open (one item, blocked on a repro case) lives in
MADR 0008.
